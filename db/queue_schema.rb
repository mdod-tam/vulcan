...
ActiveRecord::Schema[8.0].define(version: 2025_12_03_000001) do # rubocop:disable Style/NumericLiterals
  # These are extensions that must be enabled in order to support this database
  enable_extension 'pg_catalog.plpgsql'

  # Solid Queue tables only - application tables belong in db/schema.rb
  ...
  # Marker table used internally by Solid Queue
