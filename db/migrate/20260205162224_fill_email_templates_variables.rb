class FillEmailTemplatesVariables < ActiveRecord::Migration[8.0]
  TEMPLATE_CONFIG = {
    'application_notifications_application_submitted' => {
      ...
      optional: %w[title logo subtitle show_automated_message]
    },
    'application_notifications_account_created' => {
      ...
      optional: %w[title show_automated_message logo subtitle]
    },
    'application_notifications_income_threshold_exceeded' => {
      ...
      optional: %w[additional_notes status_box_text title logo subtitle show_automated_message]
    },
    ...
    'application_notifications_proof_approved' => {
      ...
      optional: %w[all_proofs_approved_message_text title logo subtitle show_automated_message]
    },
    ...
    'application_notifications_proof_rejected' => {
      ...
      optional: %w[remaining_attempts_message_text title logo subtitle show_automated_message]
    },
    ...
    'medical_provider_certification_submission_error' => {
      ...
      optional: %w[constituent_full_name application_id]
    },
    ...
    'vendor_notifications_w9_expiring_soon' => {
      ...
      optional: %w[vendor_association_message title logo subtitle show_automated_message]
    },
    ...
    'voucher_notifications_voucher_expired' => {
      ...
      optional: %w[transaction_history_text title logo subtitle show_automated_message]
    },
    'voucher_notifications_voucher_redeemed' => {
      ...
      optional: %w[minimum_redemption_amount_formatted header_text footer_text]
    },
