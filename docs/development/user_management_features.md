...
| Portal dependent creation | `app/controllers/constituent_portal/dependents_controller.rb` | Blocks exact contact collisions before persistence, then locks and requalifies the signed-in guardian plus any soft-match review candidates. The new dependent, guardian relationship, and optional duplicate-review case commit atomically; guardian contact snapshots come from the locked guardian. |
