...
class DocumentProofHandlerController extends Controller {
  ...
  updateVisibility() {
    ...
    const noneProvided = this.hasNoneRadioTarget ? this.noneRadioTarget.checked : false;
    const isRejected = this.hasRejectRadioTarget ? this.rejectRadioTarget.checked : false;
