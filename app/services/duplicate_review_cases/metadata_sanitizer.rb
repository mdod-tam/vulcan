...
module DuplicateReviewCases
  class MetadataSanitizer
    ...
    ALLOWED_INTAKE_CONTEXTS = %w[registration portal_dependent paper_intake paper_inline_keep_separate paper_inline_selection admin_create support_claim].freeze
