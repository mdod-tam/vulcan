...
module Applications
  class PaperApplicationServiceTest < ActiveSupport::TestCase
    ...
    test 'equipment paper application suppresses account_created notice for new constituent' do
      service_params = {
    ...
    test 'voucher paper application still sends account_created notice for new constituent' do
